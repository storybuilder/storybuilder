...
// <date> <time_in_24h_format_plus_milliseconds> [<message_type>] [<uuid>] [<prefix>] [<message>] [<additional_information>]
// ex:
...
func (a *LogAdapter) log(ctx context.Context, logLevel, message string, options ...interface{}) {
...
func (a *LogAdapter) formatMessage(ctx context.Context, logLevel, message string, options ...interface{}) string {
...
func (a *LogAdapter) setTag(logLevel string) interface{} {
	if a.cfg.Colors {
		...
		case "WARN":
			logLevelVal = aurora.Yellow("[WARN]")
		default:
